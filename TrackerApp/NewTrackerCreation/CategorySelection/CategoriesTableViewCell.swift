...
final class CategoriesTableViewCell: UITableViewCell {
    ...
    func setUpConstraints() {
        NSLayoutConstraint.activate([
            ...
            categoryNameLabel.leadingAnchor.constraint(equalTo: customSeparatorCell.leadingAnchor, constant: 16),
            categoryNameLabel.trailingAnchor.constraint(equalTo: customSeparatorCell.trailingAnchor, constant: -41),
            categoryNameLabel.centerYAnchor.constraint(equalTo: customSeparatorCell.centerYAnchor),
            
            checkMarkImageView.trailingAnchor.constraint(equalTo: customSeparatorCell.trailingAnchor, constant: -16),
            checkMarkImageView.centerYAnchor.constraint(equalTo: categoryNameLabel.centerYAnchor)
        ])
    }
